...
- [ ] 03-03: Runtime, run lifecycle, lineage, and the fail-closed `SpeakerEmbedder` gate are implemented; threshold calibration and a verified real gated publish remain.
