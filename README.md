...
word timestamps, waveform scrub/zoom, source gain, playback up to 8x, resizable
columns, tests, and one-click startup.
...
1. Open a project; Speech to Text contains Media Pool, Script, Recorder, and
   Timeline. It intentionally has no Voice Vault or Control Rack.
2. Use `IMPORT` in Media Pool for audio or video. Common MOV, MP4, MKV, AVI,
...
6. Edit the result directly in Script. `Nhận diện kỹ` runs another contextual
   ...
   and play at up to 8x in Timeline.
